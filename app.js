...
class BlocktoCode{
    constructor(){
        ...
        this.procs = {'variable':this.handleVariable, 'logic':this.handleOperators, 'while':this.handleLoop};
        this.headers = [];
        this.vars = {};
    };
    ...
    handleMath(element){
        if (
            element.dataset.mathType == 'single-num'
            ) {
            return (this.languageObj.createNumber(element.children[0].value));
        }

        else if (
            element.dataset.mathType == 'arithmetic-operation'
            ) {
    ...
    handleVariable(element){
        ...
        if (
            element.dataset.variableType == 'set-variable'
            ){
            if (element.children[0].children[0].className != 'warning active'){
                let valueElement = element.children[0].children[2].children[0];
                let val = '\'\'';
                let varName = element.children[0].children[1].children[0].children[0].options[element.children[0].children[1].children[0].children[0].selectedIndex].text;
            ...
            if (element.children[0].children[0].className != 'warning active'){
                return (element.children[0].children[1].children[0].children[0].options[element.children[0].children[1].children[0].children[0].selectedIndex].text);
            }
            else{
                return 
            }
    ...
    handleLoop(element){
        ...
        if (element.dataset.loopType == 'break-continue'){
            if (element.children[0].children[0].className != 'warning active'){
                if (element.children[0].children[1].options[element.children[0].children[1].selectedIndex].text == 'break out'){
            ...
            if (element.children[1].children[1].childElementCount > 0){
                ...
                for (let i=0; i < element.children[1].children[1].childElementCount; i++){
            ...
            if (element.children[0].children[1].childElementCount > 0){
                ...
                for (let i=0; i < element.children[0].children[1].childElementCount; i++){
            ...
            // Wrap Loop Variable
            if (element.children[0].children[1].children[0].children[0] != undefined){
                var_block = this.blocksManager(element.children[0].children[1].children[0].children[0]);
            }

            if (element.children[0].children[1].children[2].children[0] != undefined){
                from = this.blocksManager(element.children[0].children[1].children[2].children[0]);
            }

            if (element.children[0].children[1].children[4].children[0] != undefined){
                till = this.blocksManager(element.children[0].children[1].children[4].children[0]);
            }

            if (element.children[0].children[1].children[6].children[0] != undefined){
                increm = this.blocksManager(element.children[0].children[1].children[6].children[0]);
            }
            ...
            return (this.languageObj.createForLoop(var_block, from, till, increm, loopBody));
        }
    ...
    handleLogic(element){
        if (
            ...
            if (element.children[0].children[1].children[0] != undefined){
                condition = this.blocksManager(element.children[0].children[1].children[0]);
            }
            ...
            if (element.children[0].children[1].children[0] != undefined){
                valueBlock = this.blocksManager(element.children[0].children[1].children[0]);
            }
            return this.languageObj.createNot(valueBlock);
        }

        else if (element.dataset.logicType == 'boolean'){         
            return (element.children[0].children[0].options[element.children[0].children[0].selectedIndex].text);
        }
    }
    ...
    handleProc(element){
        ...
        if (element.dataset.procedureType == 'call-void'){
            ...
            if (element.children[1].children[0].childElementCount > 0){
                for (let i=0; i < element.children[1].children[0].childElementCount; i++){
            ...
            return this.languageObj.createProc(name, params, proc_body, proc_type, return_value);
        }
    }
